...
TEST1Stream.AddItem("xAOD::TrackParticleContainer#InDetCombinedTrackParticles")
TEST1Stream.AddItem("xAOD::TrackParticleAuxContainer#InDetCombinedTrackParticlesAux.")
